"""QUAERO EMEA dataset adapter (HuggingFace format) - Token-level.
...
class QuaeroEMEATokenAdapter(DatasetAdapter):
    """Adapter for QUAERO EMEA dataset from HuggingFace (token-level).
