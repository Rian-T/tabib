"""QUAERO MEDLINE dataset adapter (HuggingFace format).

This is the official QUAERO MEDLINE dataset with:
...
class QuaeroMEDLINEHFAdapter(DatasetAdapter):
    """Adapter for QUAERO MEDLINE dataset from HuggingFace.
    ...
    def _convert_to_spans(self, sample: dict, idx: int) -> dict[str, Any]:
        ...
        return {
            "doc_id": sample.get("id", f"medline_{idx}"),
            "text": text,
            "entities": entities,
        }
