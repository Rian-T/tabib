...
register_dataset("fracco_icd_doc", data.FRACCODocumentICDAdapter)
register_dataset("fracco_icd_doc_top30", lambda: data.FRACCODocumentICDAdapter(top_k=30))
register_dataset("fracco_icd_doc_top100", lambda: data.FRACCODocumentICDAdapter(top_k=100))
register_dataset("fracco_icd_doc_top500", lambda: data.FRACCODocumentICDAdapter(top_k=500))
...
# FRASIMED NER datasets
register_dataset("frasimed_cantemist", data.FRASIMEDCANTEMISTAdapter)
register_dataset("frasimed_distemist", data.FRASIMEDDISTEMISTAdapter)
# FRASIMED Mention-level classification (entity normalization)
register_dataset("frasimed_cantemist_norm", lambda: data.FRASIMEDMentionClassificationAdapter(subset="CANTEMIST-FRASIMED"))
register_dataset("frasimed_cantemist_norm_top30", lambda: data.FRASIMEDMentionClassificationAdapter(subset="CANTEMIST-FRASIMED", top_k=30))
register_dataset("frasimed_distemist_norm", lambda: data.FRASIMEDMentionClassificationAdapter(subset="DISTEMIST-FRASIMED"))
register_dataset("frasimed_distemist_norm_top100", lambda: data.FRASIMEDMentionClassificationAdapter(subset="DISTEMIST-FRASIMED", top_k=100))
register_dataset("frasimed_distemist_norm_top500", lambda: data.FRASIMEDMentionClassificationAdapter(subset="DISTEMIST-FRASIMED", top_k=500))
# FRASIMED Document-level multilabel classification
register_dataset("frasimed_cantemist_doc", lambda: data.FRASIMEDDocumentMultilabelAdapter(subset="CANTEMIST-FRASIMED"))
register_dataset("frasimed_cantemist_doc_top30", lambda: data.FRASIMEDDocumentMultilabelAdapter(subset="CANTEMIST-FRASIMED", top_k=30))
register_dataset("frasimed_cantemist_doc_top100", lambda: data.FRASIMEDDocumentMultilabelAdapter(subset="CANTEMIST-FRASIMED", top_k=100))
register_dataset("frasimed_distemist_doc", lambda: data.FRASIMEDDocumentMultilabelAdapter(subset="DISTEMIST-FRASIMED"))
register_dataset("frasimed_distemist_doc_top100", lambda: data.FRASIMEDDocumentMultilabelAdapter(subset="DISTEMIST-FRASIMED", top_k=100))
register_dataset("frasimed_distemist_doc_top500", lambda: data.FRASIMEDDocumentMultilabelAdapter(subset="DISTEMIST-FRASIMED", top_k=500))
